...
type SpecLearningConfig struct {
	...
	IncludeQueryParams *bool `pulumi:"includeQueryParams"`
	// Include request body during spec learning.
	IncludeRequestBody *bool `pulumi:"includeRequestBody"`
	// Include request headers during spec learning.
	IncludeRequestHeaders *bool `pulumi:"includeRequestHeaders"`
	// Include response body during spec learning.
	IncludeResponseBody *bool `pulumi:"includeResponseBody"`
	// Include response headers during spec learning.
	IncludeResponseHeaders *bool `pulumi:"includeResponseHeaders"`
...
// SpecLearningConfigInput is an input type that accepts SpecLearningConfigArgs and SpecLearningConfigOutput values.
// You can construct a concrete instance of `SpecLearningConfigInput` via:
//
//	SpecLearningConfigArgs{...}
type SpecLearningConfigInput interface {
	pulumi.Input

	ToSpecLearningConfigOutput() SpecLearningConfigOutput
	ToSpecLearningConfigOutputWithContext(context.Context) SpecLearningConfigOutput
}

type SpecLearningConfigArgs struct {
	// Include query parameters during spec learning.
	IncludeQueryParams pulumi.BoolPtrInput `pulumi:"includeQueryParams"`
	// Include request body during spec learning.
	IncludeRequestBody pulumi.BoolPtrInput `pulumi:"includeRequestBody"`
	// Include request headers during spec learning.
	IncludeRequestHeaders pulumi.BoolPtrInput `pulumi:"includeRequestHeaders"`
	// Include response body during spec learning.
	IncludeResponseBody pulumi.BoolPtrInput `pulumi:"includeResponseBody"`
	// Include response headers during spec learning.
	IncludeResponseHeaders pulumi.BoolPtrInput `pulumi:"includeResponseHeaders"`
	// Spec learning mode configuration options. Valid values: all, paths*only, paths*custom. Note: When using 'all' or 'paths*only' modes, the include** flags will be preserved in state but are not applicable as the mode overrides these settings.
	LearningMode pulumi.StringInput `pulumi:"learningMode"`
}

func (SpecLearningConfigArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*SpecLearningConfig)(nil)).Elem()
}

func (i SpecLearningConfigArgs) ToSpecLearningConfigOutput() SpecLearningConfigOutput {
	return i.ToSpecLearningConfigOutputWithContext(context.Background())
}

func (i SpecLearningConfigArgs) ToSpecLearningConfigOutputWithContext(ctx context.Context) SpecLearningConfigOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SpecLearningConfigOutput)
}

func (i SpecLearningConfigArgs) ToSpecLearningConfigPtrOutput() SpecLearningConfigPtrOutput {
	return i.ToSpecLearningConfigPtrOutputWithContext(context.Background())
}

func (i SpecLearningConfigArgs) ToSpecLearningConfigPtrOutputWithContext(ctx context.Context) SpecLearningConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SpecLearningConfigOutput).ToSpecLearningConfigPtrOutputWithContext(ctx)
}

// SpecLearningConfigPtrInput is an input type that accepts SpecLearningConfigArgs, SpecLearningConfigPtr and SpecLearningConfigPtrOutput values.
// You can construct a concrete instance of `SpecLearningConfigPtrInput` via:
//
//	        SpecLearningConfigArgs{...}
//
//	or:
//
//	        nil
type SpecLearningConfigPtrInput interface {
	pulumi.Input

	ToSpecLearningConfigPtrOutput() SpecLearningConfigPtrOutput
	ToSpecLearningConfigPtrOutputWithContext(context.Context) SpecLearningConfigPtrOutput
}

type specLearningConfigPtrType SpecLearningConfigArgs

func SpecLearningConfigPtr(v *SpecLearningConfigArgs) SpecLearningConfigPtrInput {
	return (*specLearningConfigPtrType)(v)
}

func (*specLearningConfigPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**SpecLearningConfig)(nil)).Elem()
}

func (i *specLearningConfigPtrType) ToSpecLearningConfigPtrOutput() SpecLearningConfigPtrOutput {
	return i.ToSpecLearningConfigPtrOutputWithContext(context.Background())
}

func (i *specLearningConfigPtrType) ToSpecLearningConfigPtrOutputWithContext(ctx context.Context) SpecLearningConfigPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(SpecLearningConfigPtrOutput)
}

type SpecLearningConfigOutput struct{ *pulumi.OutputState }

func (SpecLearningConfigOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*SpecLearningConfig)(nil)).Elem()
}

func (o SpecLearningConfigOutput) ToSpecLearningConfigOutput() SpecLearningConfigOutput {
	return o
}

func (o SpecLearningConfigOutput) ToSpecLearningConfigOutputWithContext(ctx context.Context) SpecLearningConfigOutput {
	return o
}

func (o SpecLearningConfigOutput) ToSpecLearningConfigPtrOutput() SpecLearningConfigPtrOutput {
	return o.ToSpecLearningConfigPtrOutputWithContext(context.Background())
}

func (o SpecLearningConfigOutput) ToSpecLearningConfigPtrOutputWithContext(ctx context.Context) SpecLearningConfigPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v SpecLearningConfig) *SpecLearningConfig {
		return &v
	}).(SpecLearningConfigPtrOutput)
}

// Include query parameters during spec learning.
func (o SpecLearningConfigOutput) IncludeQueryParams() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpecLearningConfig) *bool { return v.IncludeQueryParams }).(pulumi.BoolPtrOutput)
}

// Include request body during spec learning.
func (o SpecLearningConfigOutput) IncludeRequestBody() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpecLearningConfig) *bool { return v.IncludeRequestBody }).(pulumi.BoolPtrOutput)
}

// Include request headers during spec learning.
func (o SpecLearningConfigOutput) IncludeRequestHeaders() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpecLearningConfig) *bool { return v.IncludeRequestHeaders }).(pulumi.BoolPtrOutput)
}

// Include response body during spec learning.
func (o SpecLearningConfigOutput) IncludeResponseBody() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpecLearningConfig) *bool { return v.IncludeResponseBody }).(pulumi.BoolPtrOutput)
}

// Include response headers during spec learning.
func (o SpecLearningConfigOutput) IncludeResponseHeaders() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v SpecLearningConfig) *bool { return v.IncludeResponseHeaders }).(pulumi.BoolPtrOutput)
}

// Spec learning mode configuration options. Valid values: all, paths*only, paths*custom. Note: When using 'all' or 'paths*only' modes, the include** flags will be preserved in state but are not applicable as the mode overrides these settings.
func (o SpecLearningConfigOutput) LearningMode() pulumi.StringOutput {
	return o.ApplyT(func(v SpecLearningConfig) string { return v.LearningMode }).(pulumi.StringOutput)
}

type SpecLearningConfigPtrOutput struct{ *pulumi.OutputState }

func (SpecLearningConfigPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**SpecLearningConfig)(nil)).Elem()
}

func (o SpecLearningConfigPtrOutput) ToSpecLearningConfigPtrOutput() SpecLearningConfigPtrOutput {
	return o
}

func (o SpecLearningConfigPtrOutput) ToSpecLearningConfigPtrOutputWithContext(ctx context.Context) SpecLearningConfigPtrOutput {
	return o
}

func (o SpecLearningConfigPtrOutput) Elem() SpecLearningConfigOutput {
	return o.ApplyT(func(v *SpecLearningConfig) SpecLearningConfig {
		if v != nil {
			return *v
		}
		var ret SpecLearningConfig
		return ret
	}).(SpecLearningConfigOutput)
}

// Include query parameters during spec learning.
func (o SpecLearningConfigPtrOutput) IncludeQueryParams() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *bool {
		if v == nil {
			return nil
		}
		return v.IncludeQueryParams
	}).(pulumi.BoolPtrOutput)
}

// Include request body during spec learning.
func (o SpecLearningConfigPtrOutput) IncludeRequestBody() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *bool {
		if v == nil {
			return nil
		}
		return v.IncludeRequestBody
	}).(pulumi.BoolPtrOutput)
}

// Include request headers during spec learning.
func (o SpecLearningConfigPtrOutput) IncludeRequestHeaders() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *bool {
		if v == nil {
			return nil
		}
		return v.IncludeRequestHeaders
	}).(pulumi.BoolPtrOutput)
}

// Include response body during spec learning.
func (o SpecLearningConfigPtrOutput) IncludeResponseBody() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *bool {
		if v == nil {
			return nil
		}
		return v.IncludeResponseBody
	}).(pulumi.BoolPtrOutput)
}

// Include response headers during spec learning.
func (o SpecLearningConfigPtrOutput) IncludeResponseHeaders() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *bool {
		if v == nil {
			return nil
		}
		return v.IncludeResponseHeaders
	}).(pulumi.BoolPtrOutput)
}

// Spec learning mode configuration options. Valid values: all, paths*only, paths*custom. Note: When using 'all' or 'paths*only' modes, the include** flags will be preserved in state but are not applicable as the mode overrides these settings.
func (o SpecLearningConfigPtrOutput) LearningMode() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SpecLearningConfig) *string {
		if v == nil {
			return nil
		}
		return &v.LearningMode
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*SpecLearningConfigInput)(nil)).Elem(), SpecLearningConfigArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*SpecLearningConfigPtrInput)(nil)).Elem(), SpecLearningConfigArgs{})
	...
	pulumi.RegisterOutputType(SpecLearningConfigOutput{})
	pulumi.RegisterOutputType(SpecLearningConfigPtrOutput{})
}
