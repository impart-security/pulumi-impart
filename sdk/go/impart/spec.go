...
type Spec struct {
	...
	LearningConfig SpecLearningConfigPtrOutput `pulumi:"learningConfig"`
...
type specState struct {
	// Configuration for spec learning.
	LearningConfig *SpecLearningConfig `pulumi:"learningConfig"`
	// The name for this specification.
...
type SpecState struct {
	// Configuration for spec learning.
	LearningConfig SpecLearningConfigPtrInput
	// The name for this specification.
...
// Configuration for spec learning.
func (o SpecOutput) LearningConfig() SpecLearningConfigPtrOutput {
	return o.ApplyT(func(v *Spec) SpecLearningConfigPtrOutput { return v.LearningConfig }).(SpecLearningConfigPtrOutput)
}
