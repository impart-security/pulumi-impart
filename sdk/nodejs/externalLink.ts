...
export class ExternalLink extends pulumi.CustomResource {
     ...
     */
    declare public readonly jsonPathElement: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly specIds: pulumi.Output<string[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ExternalLinkArgs | ExternalLinkState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["jsonPathElement"] = state?.jsonPathElement;
            resourceInputs["name"] = state?.name;
            resourceInputs["specIds"] = state?.specIds;
            ...
            if (args?.jsonPathElement === undefined && !opts.urn) {
            ...
            resourceInputs["jsonPathElement"] = args?.jsonPathElement;
            resourceInputs["name"] = args?.name;
            resourceInputs["specIds"] = args?.specIds;
