...
export class Spec extends pulumi.CustomResource {
     ...
     */
    declare public readonly learningConfig: pulumi.Output<outputs.SpecLearningConfig | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: SpecArgs | SpecState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["learningConfig"] = state?.learningConfig;
            ...
            resourceInputs["learningConfig"] = args?.learningConfig;
