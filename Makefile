...
tfgen:: #install_plugins
	(cd provider && GITHUB_TOKEN=$(GITHUB_TOKEN) go build -o $(WORKING_DIR)/bin/${TFGEN} -ldflags "-X ${PROJECT}/${VERSION_PATH}=${VERSION}" ${PROJECT}/${PROVIDER_PATH}/cmd/${TFGEN})
	GITHUB_TOKEN=$(GITHUB_TOKEN) $(WORKING_DIR)/bin/${TFGEN} schema --out provider/cmd/${PROVIDER}
...
install_nodejs_sdk::
	npm link --cwd $(WORKING_DIR)/sdk/nodejs/bin
